...
int main() {
    ...
    cout << "cùng lúc v?i cùng t?n ??u k?. T?n ??u k? là g?? ";
    cin >> begInv;

    // Thi?t l?p t?n c?a m?i c?a hàng.
    store1 = store2 = store3 = begInv;

    // Nh?p s? l??ng widget ?? bán ? c?a hàng 1.
    cout << "C?a hàng 1 ?? bán bao nhiêu widget? ";
    cin >> sold;
    store1 -= sold; // ?i?u ch?nh t?n kho c?a hàng 1.

    // Nh?p s? l??ng widget ?? bán ? c?a hàng 2.
    cout << "C?a hàng 2 ?? bán bao nhiêu widget? ";
    cin >> sold;
    store2 -= sold; // ?i?u ch?nh t?n kho c?a hàng 2.

    // Nh?p s? l??ng widget ?? bán ? c?a hàng 3.
    cout << "C?a hàng 3 ?? bán bao nhiêu widget? ";
    cin >> sold;
